...
public class FbBaseClass {
	...
	public static void selectFromDropDown(String text) {
		select.selectByVisibleText(text);
	}
	public static void selectFromDropDown(int index) {
		select.selectByIndex(index);
	}
	public static String getExcelSheet(String sheetname,int rowIndex,int cellnum) throws IOException {
		File  fi = new File("C:\\Users\\Prithiv\\eclipse-workspace\\Cucumber\\ExcelSheet\\FaceBook.xlsx");
